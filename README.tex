...
about version control, there is also a list of \hyperref[sec:org382c3cd]{additional resources} and some
\hyperref[sec:org0dff573]{homework problems} at the end to test your understanding.

Please read through the \hyperref[sec:orga89c91d]{background material} first then follow along with the \hyperref[sec:org60d24a0]{worked example}. You do not need any special software installed (everything is
...
is a good idea, at which point you may want to switch to a \hyperref[sec:org79866fc]{GUI interface} too.
...
\hyperref[sec:org831e358]{repository} contains all of your commits. This can be thought of as a stronger
...
\subsubsection*{Clone}
\label{sec:orgd1cebee}

When you make a copy of a \hyperref[sec:org831e358]{repository} you are \emph{cloning} that repository. The
...
\subsubsection*{Pull}
\label{sec:org7e250db}

Suppose you \hyperref[sec:orgd1cebee]{cloned} a repository a while ago and you want to get a copy of all
the \hyperref[sec:orgacd33df]{commits} that have been made to the original repository since then. To get
...
\subsubsection*{Push}
\label{sec:orgf4b99c1}

If you have \hyperref[sec:orgacd33df]{committed} some changes to your \hyperref[sec:orgd1cebee]{clone} of a \hyperref[sec:org831e358]{repository} and want the
...
\label{sec:orgf360103}

A \emph{branch} is similar to a \hyperref[sec:orgd1cebee]{clone} in that it is a copy of a \hyperref[sec:org831e358]{repository}. This
...
\subsubsection*{Merge}
\label{sec:org1b8d383}

If someone has made some useful changes on their \hyperref[sec:orgf360103]{branch} the owner of the
...
\subsubsection*{Fork}
\label{sec:org65b0fb2}

When you make a copy of a repository that sits on your GitHub account. This is
similar to, (but distinct from) \hyperref[sec:orgd1cebee]{cloning} and making a \hyperref[sec:orgf360103]{branch}. Forking a
...
\label{sec:orgeea630c}

A pull request is a way to request that the owner of a repository accepts the
changes you are proposing. As with \hyperref[sec:org65b0fb2]{forking}, the details are of this are beyond
the scope of this tutorial.

\subsubsection*{Client}
\label{sec:org79866fc}
...
\subsection{GitHub}
\label{sec:org2d84ea5}

\subsubsection*{What is GitHub?}
\label{sec:org2476339}
...
command line or some other \hyperref[sec:org79866fc]{program}.

\subsubsection*{Setting up a GitHub account}
\label{sec:orgd236c22}
...
\label{sec:org6a50630}

Now that our code is in a reasonable state, we can upload it to GitHub. If you
do not already have a GitHub account, please follow the instructions \hyperref[sec:orgd236c22]{above},
which describe how to make one. Once you have a GitHub account, you can follow
the following steps to upload these files:

\begin{enumerate}
\item Visit \url{https://github.com/} and create a new \hyperref[sec:org831e358]{repository} by clicking \textbf{New}, you
...
\item We now need to \hyperref[sec:orgacd33df]{commit} our files and \hyperref[sec:orgf4b99c1]{push} them to the remote repository.
...
like their edits, you can \hyperref[sec:org1b8d383]{merge} them into \texttt{main} as we are about to do now.

\subsubsection*{Merge the changes}
\label{sec:orgcea974e}

To \hyperref[sec:org1b8d383]{merge} your changes via the website, go back to the main page of the
