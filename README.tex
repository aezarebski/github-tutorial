...
about version control, there is also a list of \hyperref[sec:orge3fb595]{additional resources} and some
\hyperref[sec:org4891c04]{homework problems} at the end to test your understanding.

Please read through the \hyperref[sec:org2a2c118]{background material} first then follow along with the \hyperref[sec:orgaf69dce]{worked example}. You do not need any special software installed (everything is
...
is a good idea, at which point you may want to switch to a \hyperref[sec:orga374b6c]{GUI interface} too.
...
\hyperref[sec:org84e3e96]{repository} contains all of your commits. This can be thought of as a stronger
...
\subsubsection*{Clone}
\label{sec:org4ed5260}

When you make a copy of a \hyperref[sec:org84e3e96]{repository} you are \emph{cloning} that repository. The
...
\subsubsection*{Pull}
\label{sec:org965efe9}

Suppose you \hyperref[sec:org4ed5260]{cloned} a repository a while ago and you want to get a copy of all
the \hyperref[sec:org635a54d]{commits} that have been made to the original repository since then. To get
...
\subsubsection*{Push}
\label{sec:org36b0402}

If you have \hyperref[sec:org635a54d]{committed} some changes to your \hyperref[sec:org4ed5260]{clone} of a \hyperref[sec:org84e3e96]{repository} and want the
...
\label{sec:org7358905}

A \emph{branch} is similar to a \hyperref[sec:org4ed5260]{clone} in that it is a copy of a \hyperref[sec:org84e3e96]{repository}. This
...
\subsubsection*{Merge}
\label{sec:org03d5d05}

If someone has made some useful changes on their \hyperref[sec:org7358905]{branch} the owner of the
...
\subsubsection*{Fork}
\label{sec:org621e325}

When you make a copy of a repository that sits on your GitHub account. This is
similar to, (but distinct from) \hyperref[sec:org4ed5260]{cloning} and making a \hyperref[sec:org7358905]{branch}. Forking a
...
\label{sec:orgc4122fb}

A pull request is a way to request that the owner of a repository accepts the
changes you are proposing. As with \hyperref[sec:org621e325]{forking}, the details are of this are beyond
the scope of this tutorial.

\subsubsection*{Client}
\label{sec:orga374b6c}
...
\subsection{GitHub}
\label{sec:org1232ef2}

\subsubsection*{What is GitHub?}
\label{sec:orgca41f57}
...
command line or some other \hyperref[sec:orga374b6c]{program}.

\subsubsection*{Setting up a GitHub account}
\label{sec:orgd63fcd7}
...
\label{sec:org081bd1a}

Now that our code is in a reasonable state, we can upload it to GitHub. If you
do not already have a GitHub account, please follow the instructions \hyperref[sec:orgd63fcd7]{above},
which describe how to make one. Once you have a GitHub account, you can follow
the following steps to upload these files:

\begin{enumerate}
\item Visit \url{https://github.com/} and create a new \hyperref[sec:org84e3e96]{repository} by clicking \textbf{New}, you
...
\item We now need to \hyperref[sec:org635a54d]{commit} our files and \hyperref[sec:org36b0402]{push} them to the remote repository.
...
like their edits, you can \hyperref[sec:org03d5d05]{merge} them into \texttt{main} as we are about to do now.

\subsubsection*{Merge the changes}
\label{sec:orge59f64c}

To \hyperref[sec:org03d5d05]{merge} your changes via the website, go back to the main page of the
